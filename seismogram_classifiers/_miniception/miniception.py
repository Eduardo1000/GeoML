from seismogram_classifiers._miniception import architecture_manager as am
...
def make_model(n_classes, alpha=1, seed=12345, n_blocks=4, width=99, height=99, n_channels=3) :
    ...
    for n_block in range( n_blocks ) :
        block_conv, block_res = am.blockD_2( input, initializer, num_maps1 = 2 ** (n_block) * alpha,
                                             num_maps2 = 2 ** (n_block + 1) * alpha )
